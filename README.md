...
- Matrix LED Display
- Connector between Controller & Display
- Soldering Iron (more on that below)
...
###  Connector
To connect the display to the controller I used the Matrix bonnet from Adafruit, which you can find [here](https://www.adafruit.com/product/3211)
...
### Geofox API
The geofox.py file features functions for retrieving the credentials from a secrets.json file, creating a signature for request authentification and getting a parsed list of departures for a station
### Display Logic
The hvv_display.py file creates a new canvas for the Matrix LED and takes care of scrolling the text if it doesnt fit, crafting the correct strings to display and coloring
